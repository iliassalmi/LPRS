...
<body>
        ...
        <div class="container com-sp">
            <div class="row">
                <div class="cor about-sp">
                    ...
                    <p>  CPRP : Conception des Processus de Réalisation de Produits

  <p>    Options: Production Unitaire ou Production Sérielle
  ...
  <p>    Le titulaire du BTS peut concevoir les processus de fabrication et intervenir tout au long de la chaîne de production, d’assemblage et de contrôle. De par la formation polyvalente en productique qu’il a reçue, il est rompu aux méthodes de conception, de fabrication et de gestion de production assistées par ordinateur et peut travailler dans tout service (méthodes, production, qualité, recherche) lié à la production industrielle.

  <p>    Les principaux objectifs de ce BTS sont :

  <p>    Préparer, dans les meilleures conditions, l’insertion professionnelle des futurs diplômés  en privilégiant l’acquisition de bases techniques et la maîtrise des logiciels de conception.
  <p>    Offrir aux futurs diplômés de réelles possibilités de poursuite d’études après le BTS. Plus de 50% d’entre eux poursuivent leurs cursus.
