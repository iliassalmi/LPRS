  ...
  <!--SECTION START-->
    ...
    <section id="map">
        <div class="row contact-map">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d83847.03368984624!2d2.345353158203134!3d48.949300400000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66b9c6b0800f7%3A0xa35833adc1739e08!2sLyc%C3%A9e%20Robert%20Schuman!5e0!3m2!1sfr!2sfr!4v1602513920073!5m2!1sfr!2sfr" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"
                    ...
                    <div class="tab-inn">
                        <form action="../traitement/contact.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="validate" value="" name="message"required>
                                    <label class="">Message</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" value="" name="mail"class="validate">
