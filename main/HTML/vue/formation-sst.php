                                ...
                                <ul>
									 <li>
                                        ...
                                        <div class="pg-eve-desc pg-blog-desc">
											...
											<img src="../images/facilities/formation-sst.jpg" alt="">
                    <p>  Le sauveteur secouriste du travail (SST) est un salarié de l’entreprise. Son rôle est de porter les premiers secours à toute victime d’un accident du travail ou d’un malaise, mais aussi d’être acteur de la prévention dans son entreprise. Pour cela, il doit être formé et maintenir ses compétences tous les 2 ans.</p>

  <p> La formation de 12h permet de :</p>

  <p> maîtriser la conduite à tenir et les gestes de premiers secours (mettre en sécurité la personne accidentée, réagir face à un saignement ou un étouffement, mettre en PLS, utiliser un défibrillateur…),</p>
  <p> savoir qui et comment alerter,</p>
  <p> repérer les situations dangereuses dans son entreprise et savoir à qui et comment relayer ces informations dans l’entreprise,</p>
  <p> participer éventuellement à la mise en œuvre d’actions de prévention et de protection.</p>
  <p> Conformément  à la réglementation en vigueur, il appartient à l’établissement de contribuer à l’acquisition ou à la consolidation de ces compétences en assurant la formation de base SST (en 2ndes ) ou le recyclage (en 1ères ) et en BTS (recyclage à la demande). Pour ce faire, le lycée comprend 2 formateurs SST, diplômés par l’INRS.</p>
