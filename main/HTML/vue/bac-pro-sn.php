...
<p>        Au lycée Robert Schuman, le champ d’application développé est  « Télécommunications et Réseaux Informatiques ».</p>
  ...
  <p>      A la fin de la formation, le technicien doit être capable, de façon autonome, ou en équipe :</p>

    <p>      -d’installer des équipements de différents types (Routeurs, Serveurs, PC, …)</p>
      <p>    -de les associer pour former des réseaux</p>
        <p>  -de mettre en service des logiciels spécifiques (Linux, Windows,…)</p>
        <p>  -de maîtriser le fonctionnement du réseau et d’en assurer la maintenance</p>
          <p>-de faire évoluer les systèmes informatiques</p>
